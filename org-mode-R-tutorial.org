...
([[http://orgmode.org]]) buffers. Org-mode files use headlines to organize
...
cycle through the possible visibility states of the information under
the headline, and eventually TAB will collapse the headline back to
how you see it now. One last command to note: C-c C-o opens links like
those above in your web browser. I have tried to link to the
appropriate documentation for each feature I describe.
...
* Org-mode source code blocks (Or, Finally! We can start!)
...
#+begin_src emacs-lisp :results silent
  (setq org-format-latex-options
        '(:foreground default :background "rgb 0.3 0.5 0.7" 
                      :scale 1.5
